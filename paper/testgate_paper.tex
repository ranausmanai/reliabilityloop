...
\textbf{Code generation.} HumanEval~\cite{humaneval}, subset of 50 tasks.
We measure pass@1 with execution-based evaluation.
...
\textbf{Reproducibility.} All runs use the same 50 HumanEval tasks (IDs: 0, 1, 10--14, 100--142).
